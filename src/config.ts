...
const schema = z.object({
  ...
  // Private admin dashboard. ADMIN_DISCORD_IDS is comma-separated.
  ADMIN_DISCORD_IDS: commaSeparated,
  DASHBOARD_PUBLIC_URL: optionalUrl,
  DASHBOARD_SESSION_SECRET: optionalString,
  DASHBOARD_ENCRYPTION_KEY: optionalString,
